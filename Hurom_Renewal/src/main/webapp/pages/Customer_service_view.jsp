		...
		<table border="1" width="90%">	
			...
			<!-- 삭제1/ 수정1 -->	
				...
				<!-- mode = EditController에 연결되어 있음 -->	
					<button type="button" onclick="location.href='../mvc2/pass.do?mode=edit&idx=${param.idx}'">수정하기</button>
					<button type="button" onclick="location.href='../mvc2/pass.do?mode=delete&idx=${param.idx}'">삭제하기</button>
					<button type="button" onclick="location.href='../mvc2/listQNA.do?'">목록보기</button>	
				</td>	
			</tr>
		</table>             
    </main>
