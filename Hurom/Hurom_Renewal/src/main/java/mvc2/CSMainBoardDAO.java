...
public class CSMainBoardDAO extends DBConnPool{

	public CSMainBoardDAO() {
		super();
	}
	...
	public int selectCount(Map<String, Object> map) {
		...
		//목록10
		//쿼리문 생성
		String query = "SELECT COUNT(*) FROM test1.csmainboard ";
	...
	public int insertWrite(CSMainBoardDTO dto) {
		int result = 0;
		try {
			
			//글쓰기 22. 쿼리문 작성하고 실행하기
			String query = "INSERT INTO test1.csmainboard ( "
	...
	public CSMainBoardDTO selectView(String idx) {
		...
		//상세보기12. 쿼리문 양식 준비
		String query ="SELECT * FROM test1.csmainboard WHERE idx=?";
	...
	public void downCountPlus(String idx) {
		...
		String sql = "UPDATE test1.csmainboard"
