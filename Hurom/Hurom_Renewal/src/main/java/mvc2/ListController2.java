...
public class ListController2 extends HttpServlet{
	...
	protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		...
		String pagingImg = BoardPage.pagingStr(totalCount, pageSize, blockPage, pageNum, "../mvc2/listQNA.do");
		...
		req.getRequestDispatcher("/pages/Customer_service_q&a_board.jsp").forward(req, resp);
	}
}
