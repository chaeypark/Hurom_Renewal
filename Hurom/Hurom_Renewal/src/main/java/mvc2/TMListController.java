...
public class TMListController extends HttpServlet{
	
	@Override
	//목록 3. doget 메서드 호출
	protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		//목록4. DAO 생성
		TMBoardDAO dao = new TMBoardDAO();
		...
		String pagingImg = BoardPage.pagingStr(totalCount, pageSize, blockPage, pageNum, "../mvc2/listTM.do");
		...
		req.getRequestDispatcher("/pages/teakettle.jsp").forward(req, resp);
	}
}
