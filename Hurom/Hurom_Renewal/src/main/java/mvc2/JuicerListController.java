...
public class JuicerListController extends HttpServlet{
	
	@Override
	//목록 3. doget 메서드 호출
	protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		//목록4. DAO 생성
		JuicerBoardDAO dao = new JuicerBoardDAO();
		...
		//목록18. 게시물 목록 받아오기
		List<JuicerBoardDTO> boardLists = dao.selectListPage(map);
		...
		String pagingImg = BoardPage.pagingStr(totalCount, pageSize, blockPage, pageNum, "../mvc2/listJuicer.do");
		...
		req.getRequestDispatcher("/pages/juicer.jsp").forward(req, resp);
	}
}
