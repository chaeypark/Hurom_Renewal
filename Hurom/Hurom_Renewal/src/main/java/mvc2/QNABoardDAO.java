...
public class QNABoardDAO extends DBConnPool{
	...
	public int selectCount(Map<String, Object> map) {
		...
		//목록10
		//쿼리문 생성
		String query = "SELECT COUNT(*) FROM test1.qnaboard ";
	...
	public int insertWrite(QNABoardDTO dto) {
		...
		try {
			...
			String query = "INSERT INTO test1.qnaboard ( "
	...
	public QNABoardDTO selectView(String idx) {
		...
		//상세보기12. 쿼리문 양식 준비
		String query ="SELECT * FROM test1.qnaboard WHERE idx=?";
	...
	public void updateVisitCount(String idx) {	
		...
		//상세보기7. 쿼리문 작성 
		String query = "UPDATE test1.qnaboard " 
	...
	public void downCountPlus(String idx) {
		...
		String sql = "UPDATE test1.qnaboard"
	...
	public int deletePost(String idx) {
		...
		try {
			//삭제23.
			String query = "DELETE FROM test1.qnaboard WHERE idx = ?";
			psmt = con.prepareStatement(query);
			psmt.setString(1, idx);
			result = psmt.executeUpdate();
