...
public class ListController3 extends HttpServlet{
	...
	protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		...
		//목록18. 게시물 목록 받아오기
		List<ComponentBoardDTO> boardLists = dao.selectListPage(map);
		...
		String pagingImg = BoardPage.pagingStr(totalCount, pageSize, blockPage, pageNum, "../mvc2/listAS.do");
		...
		req.getRequestDispatcher("/pages/ComponentRequest_board.jsp").forward(req, resp);
	}
}
